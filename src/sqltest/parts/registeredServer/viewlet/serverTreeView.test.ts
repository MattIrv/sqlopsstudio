...
suite('ServerTreeView onAddConnectionProfile handler tests', () => {
	...
	setup(() => {
		...
		serverTreeView = new ServerTreeView(mockConnectionManagementService.object, instantiationService, undefined, undefined, undefined, undefined, undefined /* todo mairvine this needs a real mock to pass */);
		let tree = <Tree>{
			clearSelection() { },
			getSelection() { },
			select(selection) { },
