...
export class ExtHostNotebook implements ExtHostNotebookShape {
	...
	private _withProvider<R>(handle: number, callback: (provider: sqlops.nb.NotebookProvider) => R | PromiseLike<R>): Promise<R> {
	...
	private _withServerManager<R>(handle: number, callback: (manager: sqlops.nb.ServerManager) => R | PromiseLike<R>): Promise<R> {
	...
	private _withContentManager<R>(handle: number, callback: (manager: sqlops.nb.ContentManager) => R | PromiseLike<R>): Promise<R> {
		return this._withNotebookManager(handle, (notebookManager) => {
	...
	private _withSessionManager<R>(handle: number, callback: (manager: sqlops.nb.SessionManager) => R | PromiseLike<R>): Promise<R> {
		return this._withNotebookManager(handle, (notebookManager) => {
